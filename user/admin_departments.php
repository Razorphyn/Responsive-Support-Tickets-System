				...
				buttons: {
					"Keep Related Tickets": function() {
						var request= $.ajax({
							...
							data: {act:'del_dep',sub:'del_name',id:id},
							dataType : 'json',
					...
					"Every Information": function() {
						var request= $.ajax({
							type: 'POST',
							url: '../php/admin_function.php',
							data: {act:'del_dep',sub:'del_every',id:id},
							dataType : 'json',
							success : function (data) {
								if(data[0]=='Deleted')
									table.fnDeleteRow(pos);
